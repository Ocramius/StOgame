...
AllianceNote.prototype.load=function()
{
	try
	{
		...
		getnotequery.bindInt32Parameter(0,this.id);
...
AllianceNote.prototype.set=function(note)
{
	try
	{
		this.note=note;
...
AllianceNote.prototype.save=function()
{
	try
	{
		...
		setnotequery.bindInt32Parameter(0,this.id);
